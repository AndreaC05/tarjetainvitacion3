        ...
        <div className="calendario_dias">
          {calendario.map((dia, index) => (
            ...
            >
              {dia && (
                <>
                  {diasEspeciales[dia] === "osito" && (
                    <span className="icono_especial imagen_osito">
                      <img
                        src="https://res.cloudinary.com/dnao6nouz/image/upload/v1757955745/dos_ositos_%EF%B8%8F_1_vgm0hr.png"
                        alt="Osito"
                      />
                    </span>
                  )}
